...
def register(data): 
    response = dict()
    response['status'] = 200
    response['message'] = driver.add_user(name=data['name'], date_of_birth=data['dob'], username=data['username'], password=data['password'])
    response['error'] = None
...
def get_transactions(user, offset, limit): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_transactions(user, offset, limit)
    response['error'] = None
    return response
...
def add_transaction(user, data): 
    response = dict()
    response['status'] = 200
    response['message'] = driver.add_transaction(user, date=data['date'], type=data['type'], category=data['category'], dealer=data['dealer'], status=data['status'])
    response['error'] = None
    return response
...
def delete_transaction(user, doc_id): 
    response = dict()
    response['status'] = 200
    response['message'] = driver.delete_transaction(user, doc_id)
    response['error'] = None
    return response
...
def get_transaction_by_id(user, doc_id): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_tansaction_by_id(user, doc_id)
    response['error'] = None
    return response
...
def update_transactions(user, data): 
    response = dict()
    response['status'] = 200
    response['message'] = driver.update_transactions(user, doc_id=data['id'], date=data['date'], type=data['type'], category=data['category'], dealer=data['dealer'], status=data['status'])
    response['erorr'] = None
    return response
...
def get_debt_list(user, offset, limit): 
    response = dict() 
    response['status'] = 200
    response['data'] = driver.get_debt_list(user, offset, limit)
    response['error'] = None
    return response
...
def get_owe_list(user, offset, limit): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_owe_list(user, offset, limit)
    response['error'] = None
    return response
...
def get_all_categories(user): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_all_categories(user)
    response['error'] = None
    return response
...
def get_summary_by_category(user): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_summary_by_category(user)
    response['error'] = None
    return response
...
def get_summary_by_weekdays(user): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_summary_by_weekdays(user)
    response['error'] = None
    return response
...
def get_credit_transactions(user, offset, limit): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_credit_transactions(user, offset, limit)
    response['error'] = None
    return response
...
def get_debit_transactions(user, offset, limit): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_debit_transactions(user, offset, limit)
    response['error'] = None
    return response
...
def get_saved_transactions(user, offset, limit): 
    response = dict()
    response['status'] = 200
    response['data'] = driver.get_saved_transactions(user, offset, limit)
    response['error'] = None
    return response
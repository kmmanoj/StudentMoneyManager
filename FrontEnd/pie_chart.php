    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="nav nav-tabs nav-fill">
                <li class="nav-item active"><a href="#1" aria-controls="1" role="tab" data-toggle="tab">Pie Chart- By Category</a></li>
                <li class="nav-item"><a href="#2" aria-controls="2" role="tab" data-toggle="tab">Pie Chart- By Weekday</a></li>  
            </ul>

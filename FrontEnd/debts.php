...
<html>
    ...
    <body onload="getAll()">
        ...
        <div class="container">
        <div class="jumbotron">
        <center><h3><b>Debt List : Select to update</b></h3></center>
        <form class="form" action="updateTheseDebts.php" method="POST">
        ...
        <script type="text/javascript" src="js/debts.js"></script>
        <script type="text/javascript" src="js/getDebts.js"></script>
    </body>
</html>